...
$page_title = 'Best Sellers | ApnaCart';
...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <p class="eyebrow mb-2">Top picks</p>
            <h2 class="fw-bold mb-0">Best Sellers</h2>
        </div>
        <a href="shop.php" class="btn btn-outline-primary rounded-pill px-3">View all products</a>
    </div>
    ...
    <div class="row g-4">
        <?php if ($result && mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <div class="col-12 text-center py-5 text-muted">No best sellers available right now.</div>
        <?php endif; ?>
    </div>
</div>
